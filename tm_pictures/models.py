...
class Picture(models.Model):
    ...
    owner = models.ForeignKey(User, blank=False, null=False, related_name='picture_owner')
...
class InlineTag(models.Model):
    ...
    tagged_user = models.ForeignKey(User, blank=False, null=False, related_name='tagged_user')
